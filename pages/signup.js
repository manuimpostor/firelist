...
const Signup = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch (`${process.env.SERVER_URL}/user/new`, {
        method: "POST",
        credentials: "include",
    ...
    <div className="container">
      ...
      <div className="productPitch">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <input className="fireButton" type="submit" value="Signup"/>
        </form>
        </div>
      </div>
      <div>
        <div className="secondaryCopy">Or login to your existing account here
        <button className="outlineButton" onClick={ handleSignIn }>Sign In</button>
        </div>
      </div>
      <footer>
